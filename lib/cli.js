...
(function() {
  var BAD_DIR, BAD_FILE, BAD_FORMAT, async, csvify, fs, getExtension, parseDir, parseFile, print, programm, sloc, stats;
  ...
  csvify = function(data) {
    var lineize, lines, sf, _i, _len, _ref;
  ...
  programm.version('0.0.2').usage('[option] <file>|<directory>').option('-j, --json', 'return JSON object').option('-c, --csv', 'return CSV').option('-s, --sloc', 'print only number of source lines').option('-v, --verbose', 'print or add analzed files').option('-e, --exclude <regex>', 'regular expression to exclude files and folders');
