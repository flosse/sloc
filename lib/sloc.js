...
(function() {
  var combine, doubleSlashComment, keys, sharpComment, singleLineHtmlComment, singleLineSlashStarComment, slashStarComment, slocModule, starSlashComment, startHtmlComment, stopHtmlComment, trippleQuoteComment, trippleSharpComment, whiteSpaceLine;
  ...
  slocModule.extensions = ["coffeescript", "coffee", "python", "py", "javascript", "js", "c", "cc", "java", "php", "php5", "go", "scss", "less", "css", "html"];
