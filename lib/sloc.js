...
(function() {
  ...
  slocModule = function(code, lang) {
    var cloc, loc, mcloc, mxloc, nloc, res, scloc, sloc, _ref, _ref1;
    if (typeof code !== "string") {
      throw new TypeError("'code' has to be a string");
    }
    loc = 1 + ((_ref = code.match(newLines)) != null ? _ref.length : void 0) || 0;
    nloc = ((_ref1 = code.match(emptyLines)) != null ? _ref1.length : void 0) || 0;
  ...
  slocModule.extensions = ["coffee", "py", "js", "c", "cc", "cpp", "h", "hpp", "ino", "erl", "java", "php", "php5", "go", "lua", "scss", "less", "css", "styl", "html"];
